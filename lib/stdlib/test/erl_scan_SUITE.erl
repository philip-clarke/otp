...
reserved_words() ->
    ...
    [begin
         ...
         S = atom_to_list(RW),
         Attrs = [{line,1},{column,1},{'end',{1,length(atom_to_list(RW))+1}}],
         Ts = [{RW,Attrs}],
...
atoms() ->
    ?line test_string("a
                 b", [{atom,[{line,1},{column,1},{'end',{1,2}}],a},
                      {atom,[{line,2},{column,18},{'end',{2,19}}],b}]),
    ?line test_string("'a b'",
                      [{atom,[{line,1},{column,1},{'end',{1,6}}],'a b'}]),
    ?line test_string("a", [{atom,[{line,1},{column,1},{'end',{1,2}}],a}]),
    ?line test_string("a@2", [{atom,[{line,1},{column,1},{'end',{1,4}}],a@2}]),
    ?line test_string([39,65,200,39],
                      [{atom,[{line,1},{column,1},{'end',{1,5}}],'AÈ'}]),
    ?line test_string("ärlig östen",
                      [{atom,[{line,1},{column,1},{'end',{1,6}}],ärlig},
                       {atom,[{line,1},{column,7},{'end',{1,12}}],östen}]),
...
punctuations() ->
    ...
    [begin
         W = list_to_atom(S),
         Ts = [{W,[{line,1},{column,1},{'end',{1,length(S)+1}}]}],
         ?line test_string(S, Ts)
     end || S <- L],
    Three = ["/=:=", "<=:=", "==:=", ">=:="], % three tokens...
    No = Three ++ L,
    ...
    [begin
         W1 = list_to_atom(S1),
         W2 = list_to_atom(S2),
         Ts = [{W1,[{line,1},{column,1},{'end',{1,-L2+1}}]},
               {W2,[{line,1},{column,-L2+1},{'end',{1,-L2+length(S2)+1}}]}],
         ?line test_string(S, Ts)
     end || {S,[{L2,S1,S2}|_]}  <- SL],

    PTs1 = [{'!',[{line,1},{column,1},{'end',{1,2}}]},
            {'(',[{line,1},{column,2},{'end',{1,3}}]},
            {')',[{line,1},{column,3},{'end',{1,4}}]},
            {',',[{line,1},{column,4},{'end',{1,5}}]},
            {';',[{line,1},{column,5},{'end',{1,6}}]},
            {'=',[{line,1},{column,6},{'end',{1,7}}]},
            {'[',[{line,1},{column,7},{'end',{1,8}}]},
            {']',[{line,1},{column,8},{'end',{1,9}}]},
            {'{',[{line,1},{column,9},{'end',{1,10}}]},
            {'|',[{line,1},{column,10},{'end',{1,11}}]},
            {'}',[{line,1},{column,11},{'end',{1,12}}]}],
    ?line test_string("!(),;=[]{|}", PTs1),

    PTs2 = [{'#',[{line,1},{column,1},{'end',{1,2}}]},
            {'&',[{line,1},{column,2},{'end',{1,3}}]},
            {'*',[{line,1},{column,3},{'end',{1,4}}]},
            {'+',[{line,1},{column,4},{'end',{1,5}}]},
            {'/',[{line,1},{column,5},{'end',{1,6}}]},
            ...
            {'@',[{line,1},{column,10},{'end',{1,11}}]},
            {'\\',[{line,1},{column,11},{'end',{1,12}}]},
            {'^',[{line,1},{column,12},{'end',{1,13}}]},
            {'`',[{line,1},{column,13},{'end',{1,14}}]},
            {'~',[{line,1},{column,14},{'end',{1,15}}]}],
    ?line test_string("#&*+/:<>?@\\^`~", PTs2),

    ?line test_string(".. ", [{'..',[{line,1},{column,1},{'end',{1,3}}]}]),
    ?line test_string("1 .. 2",
                      [{integer,[{line,1},{column,1},{'end',{1,2}}],1},
                       {'..',[{line,1},{column,3},{'end',{1,5}}]},
                       {integer,[{line,1},{column,6},{'end',{1,7}}],2}]),
    ?line test_string("...", [{'...',[{line,1},{column,1},{'end',{1,4}}]}]),
    ok.
...
comments() ->
    ...
    ?line test("a %%\n b"),
    ?line {ok,[{atom,{1,1},a},{atom,{2,2},b}],{2,3}} =
        erl_scan:string("a %%\n b",{1,1}),
    ?line {ok,[{atom,{1,1},a},{comment,{1,3},"%%"},{atom,{2,2},b}],{2,3}} =
...
errors() ->
    ...
    ?line {error,{{1,1},erl_scan,{string,$',"qa"}},{1,4}} = %'
        erl_scan:string("'qa", {1,1}, []), %'
    ?line {error,{1,erl_scan,{string,$","str"}},1} = %"
        erl_scan:string("\"str"), %"
    ?line {error,{{1,1},erl_scan,{string,$","str"}},{1,5}} = %"
        erl_scan:string("\"str", {1,1}, []), %"
    ?line {error,{1,erl_scan,char},1} = erl_scan:string("$"),
    ?line {error,{{1,1},erl_scan,char},{1,2}} = erl_scan:string("$", {1,1}, []),
    ?line test_string([34,65,200,34],
                      [{string,[{line,1},{column,1},{'end',{1,5}}],"AÈ"}]),
    ?line test_string("\\", [{'\\',[{line,1},{column,1},{'end',{1,2}}]}]),
    ?line {'EXIT',_} =
...
integers() ->
    [begin
         I = list_to_integer(S),
         Ts = [{integer,[{line,1},{column,1},{'end',{1,length(S)+1}}],I}],
         ?line test_string(S, Ts)
...
base_integers() ->
    [begin
         ...
         Ts = [{integer,[{line,1},{column,1},{'end',{1,length(String)+1}}],I}],
         ?line test_string(String, Ts)
     end || {BS,S} <- [{"2","11"}, {"5","23234"}, {"12","05a"},
                       {"16","abcdef"}, {"16","ABCDEF"}] ],

    ?line {error,{1,erl_scan,{base,1}},1} = erl_scan:string("1#000"),
    ?line {error,{{1,1},erl_scan,{base,1}},{1,2}} =
        erl_scan:string("1#000", {1,1}, []),

    ?line test_string("12#bc",
                      [{integer,[{line,1},{column,1},{'end',{1,5}}],11},
                       {atom,[{line,1},{column,5},{'end',{1,6}}],c}]),
    ...
    ?line {ok,[{integer,{1,1},239},{'@',{1,6}}],{1,7}} =
        erl_scan:string("16#ef@", {1,1}, []),
    ?line {ok,[{integer,{1,1},14},{atom,{1,5},g@}],{1,7}} =
...
floats() ->
    [begin
         F = list_to_float(FS),
         Ts = [{float,[{line,1},{column,1},{'end',{1,length(FS)+1}}],F}],
         ?line test_string(FS, Ts)
     end || FS <- ["1.0","001.17","3.31200","1.0e0","1.0E17",
                   "34.21E-18", "17.0E+14"]],
    ?line test_string("1.e2", [{integer,[{line,1},{column,1},{'end',{1,2}}],1},
                               {'.',[{line,1},{column,2},{'end',{1,3}}]},
                               {atom,[{line,1},{column,3},{'end',{1,5}}],e2}]),

    ?line {error,{1,erl_scan,{illegal,float}},1} =
        erl_scan:string("1.0e400"),
    ?line {error,{{1,1},erl_scan,{illegal,float}},{1,8}} =
        erl_scan:string("1.0e400", {1,1}, []),
    [begin
         ?line {error,{1,erl_scan,{illegal,float}},1} = erl_scan:string(S),
         ?line {error,{{1,1},erl_scan,{illegal,float}},{1,_}} =
...
dots() ->
    Dot = [{".",    {ok,[{dot,1}],1},
                    {ok,[{dot,{1,1}}],{1,2}},
                    {ok,[{dot,[{line,1},{column,1},{'end',{1,2}}]}],{1,2}}},
           {". ",   {ok,[{dot,1}],1},
                    {ok,[{dot,{1,1}}],{1,3}},
                    {ok,[{dot,[{line,1},{column,1},{'end',{1,3}}]}],{1,3}}},
           {".\n",  {ok,[{dot,1}],2},
                    {ok,[{dot,{1,1}}],{2,1}},
                    {ok,[{dot,[{line,1},{column,1},{'end',{2,1}}]}],{2,1}}},
           {".%",   {ok,[{dot,1}],1},
                    {ok,[{dot,{1,1}}],{1,3}},
                    {ok,[{dot,[{line,1},{column,1},{'end',{1,2}}]}],{1,3}}},
           {".\210",{ok,[{dot,1}],1},
                    {ok,[{dot,{1,1}}],{1,3}},
                    {ok,[{dot,[{line,1},{column,1},{'end',{1,3}}]}],{1,3}}},
           {".% öh",{ok,[{dot,1}],1},
                    {ok,[{dot,{1,1}}],{1,6}},
                    {ok,[{dot,[{line,1},{column,1},{'end',{1,2}}]}],{1,6}}},
           {".%\n", {ok,[{dot,1}],2},
                    {ok,[{dot,{1,1}}],{2,1}},
                    {ok,[{dot,[{line,1},{column,1},{'end',{1,2}}]}],{2,1}}},
           ...
           {".a",   {ok,[{'.',1},{atom,1,a}],1},
                    ...
                    {ok,[{'.',[{line,1},{column,1},{'end',{1,2}}]},
                         {atom,[{line,1},{column,2},{'end',{1,3}}],a}],
                        {1,3}}}
          ],
    ?line [begin
               R = erl_scan:string(S),
               R2 = erl_scan:string(S, {1,1}, []),
               R3 = erl_scan:string(S, {1,1}, ['end'])
           end || {S, R, R2, R3} <- Dot],

    ?line {ok,[{dot,_}=T1],{1,2}} = erl_scan:string(".", {1,1}, [text, 'end']),
    ?line [{column,1},{length,1},{line,1},{text,"."},{'end',{1,2}}] =
        erl_scan:token_info(T1, [column, length, line, text, 'end']),
    ?line {ok,[{dot,_}=T2],{1,3}} = erl_scan:string(".%", {1,1}, [text, 'end']),
    ?line [{column,1},{length,1},{line,1},{text,"."},{'end',{1,2}}] =
        erl_scan:token_info(T2, [column, length, line, text, 'end']),
    ?line {ok,[{dot,_}=T3],{1,6}} =
        erl_scan:string(".% öh", {1,1}, [text, 'end']),
    ?line [{column,1},{length,1},{line,1},{text,"."},{'end',{1,2}}] =
        erl_scan:token_info(T3, [column, length, line, text, 'end']),
    ?line {error,{{1,2},erl_scan,char},{1,3}} =
        erl_scan:string(".$", {1,1}),
    ?line {error,{{1,2},erl_scan,char},{1,4}} =
        erl_scan:string(".$\\", {1,1}),

    ?line test_string(". ", [{dot,[{line,1},{column,1},{'end',{1,3}}]}]),
    ?line test_string(".  ", [{dot,[{line,1},{column,1},{'end',{1,3}}]}]),
    ?line test_string(".\n", [{dot,[{line,1},{column,1},{'end',{2,1}}]}]),
    ?line test_string(".\n\n", [{dot,[{line,1},{column,1},{'end',{2,1}}]}]),
    ?line test_string(".\n\r", [{dot,[{line,1},{column,1},{'end',{2,1}}]}]),
    ?line test_string(".\n\n\n", [{dot,[{line,1},{column,1},{'end',{2,1}}]}]),
    ?line test_string(".\210", [{dot,[{line,1},{column,1},{'end',{1,3}}]}]),
    ?line test_string(".%\n", [{dot,[{line,1},{column,1},{'end',{1,2}}]}]),
    ?line test_string(".a", [{'.',[{line,1},{column,1},{'end',{1,2}}]},
                             {atom,[{line,1},{column,2},{'end',{1,3}}],a}]),

    ?line test_string("%. \n. ", [{dot,[{line,2},{column,1},{'end',{2,3}}]}]),
    ?line {more,C} = erl_scan:tokens([], "%. ",{1,1}, [return, 'end']),
    ?line {done,{ok,[{comment,[{line,1},{column,1},{'end',{1,4}}],"%. "},
                     {white_space,[{line,1},{column,4},{'end',{2,1}}],"\n"},
                     {dot,[{line,2},{column,1},{'end',{2,3}}]}],
                 {2,3}}, ""} =
        erl_scan:tokens(C, "\n. ", {1,1}, [return, 'end']), % any loc, any options

    ?line [test_string(S, R) ||
              {S, R} <- [{".$\n",
                          [{'.',[{line,1},{column,1},{'end',{1,2}}]},
                           {char,[{line,1},{column,2},{'end',{2,1}}],$\n}]},
                         {"$\\\n",
                          [{char,[{line,1},{column,1},{'end',{2,1}}],$\n}]},
                         {"'\\\n'",
                          [{atom,[{line,1},{column,1},{'end',{2,2}}],'\n'}]},
                         {"$\n",
                          [{char,[{line,1},{column,1},{'end',{2,1}}],$\n}]}] ],
    ok.
...
chars() ->
    [begin
         ...
         Ts = [{char,[{line,1},{column,1},{'end',{1,length(L)+1}}],C}],
    ...
    [begin
         L = "$\\^" ++ [C],
         Attrs = [{line,1},{column,1},{'end',{1,length(L)+1}}],
         Ts = [{char,Attrs,C band 2#11111}],
         ?line test_string(L, Ts)
     end || C <- lists:seq(0, 255), C =/= $\n],
    ?line test_string("$\\^\n",
                      [{char,[{line,1},{column,1},{'end',{2,1}}],10}]),

    [begin
         L = "$\\" ++ [C],
         Ts = [{char,[{line,1},{column,1},{'end',{1,4}}],V}],
         ?line test_string(L, Ts)
     end || {C,V} <- [{$n,$\n}, {$r,$\r}, {$t,$\t}, {$v,$\v},
                      {$b,$\b}, {$f,$\f}, {$e,$\e}, {$s,$\s},
                      {$d,$\d}]],
    ...
    [begin
         L = "$\\" ++ [C],
         Ts = [{char,[{line,1},{column,1},{'end',{1,4}}],C}],
         ?line test_string(L, Ts)
     end || C <- lists:seq(0, 255) -- No],

    [begin
         L = "'$\\" ++ [C] ++ "'",
         Attrs = [{line,1},{column,1},{'end',{1,6}}],
         Ts = [{atom,Attrs,list_to_atom("$"++[C])}],
         ?line test_string(L, Ts)
     end || C <- lists:seq(0, 255) -- No],

    ?line test_string("\"\\013a\\\n\"",
                      [{string,[{line,1},{column,1},{'end',{2,2}}],"\va\n"}]),

    ?line test_string("'\n'",
                      [{atom,[{line,1},{column,1},{'end',{2,2}}],'\n'}]),
    ?line test_string("\"\na\"",
                      [{string,[{line,1},{column,1},{'end',{2,3}}],"\na"}]),

    %% No escape
    [begin
         L = "$" ++ [C],
         Ts = [{char,[{line,1},{column,1},{'end',{1,3}}],C}],
         ?line test_string(L, Ts)
     end || C <- lists:seq(0, 255) -- (No ++ [$\\])],
    ?line test_string("$\n", [{char,[{line,1},{column,1},{'end',{2,1}}],$\n}]),
...
variables() ->
    ?line test_string("     \237_Aouåeiyäö",
                      [{var,[{line,1},{column,7},{'end',{1,17}}],
                        '_Aouåeiyäö'}]),
    ?line test_string("A_b_c@",
                      [{var,[{line,1},{column,1},{'end',{1,7}}],'A_b_c@'}]),
    ?line test_string("V@2", [{var,[{line,1},{column,1},{'end',{1,4}}],'V@2'}]),
    ?line test_string("ABDÀ",
                      [{var,[{line,1},{column,1},{'end',{1,5}}],'ABDÀ'}]),
    ?line test_string("Ärlig Östen",
                      [{var,[{line,1},{column,1},{'end',{1,6}}],'Ärlig'},
                       {var,[{line,1},{column,7},{'end',{1,12}}],'Östen'}]),
    ok.
...
eof() ->
    ...
    %% With end locations.
    ?line {more, C3End} = erl_scan:tokens([],"    \n",{1,1},['end']),
    ?line {done,{eof,{2,1}},eof} =
        erl_scan:tokens(C3End, eof, 1),
    {more, C4End} = erl_scan:tokens([], "abra", {1,1}, ['end']),
    Abra = {atom,[{line,1},{column,1},{'end',{1,5}}],abra},
    ?line {done,{ok,[Abra],{1,5}},eof} = erl_scan:tokens(C4End, eof, 1),
    ...
    %% With column.
    ?line {more, C6} = erl_scan:tokens([], "a", {1,1}),
    %% An error before R13A.
    %% ?line {done,{error,{1,erl_scan,scan},1},eof} =
    ?line {done,{ok,[{atom,{1,1},a}],{1,2}},eof} =
        erl_scan:tokens(C6,eof,1),

    %% With end locations.
    ?line {more, C6End} = erl_scan:tokens([], "a", {1,1}, ['end']),
    ?line {done,{ok,[{atom,[{line,1},{column,1},{'end',{1,2}}],a}],{1,2}},eof} =
        erl_scan:tokens(C6End,eof,1),
    ...
    %% With column.
    ?line {more, CCol} = erl_scan:tokens([], "a.", {1,1}),
    ?line {done,{ok,[{atom,{1,1},a},{dot,{1,2}}],{1,3}},eof} =
        erl_scan:tokens(CCol,eof,1),
    ?line {ok,[{atom,{1,1},foo},{dot,{1,4}}],{1,5}} =
        erl_scan:string("foo.", {1,1}, []),

    %% With end locations.
    ?line {more, CEnd} = erl_scan:tokens([], "a.", {1,1}, ['end']),
    ?line {done,{ok,[{atom,[{line,1},{column,1},{'end',{1,2}}],a},
                     {dot,[{line,1},{column,2},{'end',{1,3}}]}],{1,3}},eof} =
        erl_scan:tokens(CEnd,eof,1),
    ?line {ok,[{atom,[{line,1},{column,1},{'end',{1,4}}],foo},
               {dot,[{line,1},{column,4},{'end',{1,5}}]}],{1,5}} =
        erl_scan:string("foo.", {1,1}, ['end']),
...
more_options() ->
    ?line {ok,[{atom,A1,foo}],{19,20}} =
        erl_scan:string("foo", {19,17},['end']),
    ?line [{column,17},{line,19},{'end',{19,20}}] =
        erl_scan:attributes_info(A1),
    ?line {done,{ok,[{atom,A2,foo},{dot,_}],{19,22}},[]} =
        erl_scan:tokens([], "foo. ", {19,17}, ['end', bad_opt]), % type error
    ?line [{column,17},{line,19},{'end',{19,20}}] =
        erl_scan:attributes_info(A2),
    ?line {ok,[{atom,A3,foo}],{19,20}} =
        erl_scan:string("foo", {19,17},[text,'end']),
    ?line [{column,17},{length,3},{line,19},{text,"foo"},{'end',{19,20}}] =
        erl_scan:attributes_info(A3),

    ?line {ok,[{atom,A4,foo}],1} = erl_scan:string("foo", 1, [text,'end']),
    ?line [{length,3},{line,1},{text,"foo"}] = erl_scan:attributes_info(A4),

    ok.

token_info() ->
    ?line {ok,[T1],_} = erl_scan:string("foo", {1,18}, [text,'end']),
    {'EXIT',{badarg,_}} =
    ...
    ?line {'end',{1,21}} = erl_scan:token_info(T1, 'end'),
    ?line [{category,atom},{column,18},{length,3},{line,1},
           {symbol,foo},{text,"foo"},{'end',{1,21}}] =
    ...
    ?line {ok,[T2],_} = erl_scan:string("foo", 1, ['end']),
    ...
    ?line undefined = erl_scan:token_info(T2, 'end'),
...
attributes_info() ->
    ...
    ?line {ok,[{atom,A3,foo}],_} = erl_scan:string("foo", {1,3}, [text,'end']),
    ...
    ?line {'end',{1,6}} = erl_scan:attributes_info(A3, 'end'),

    ?line {ok,[{atom,A4,foo}],_} = erl_scan:string("foo", 2, [text, 'end']),
    ...
    ?line undefined = erl_scan:attributes_info(A4, 'end'),

    ?line {ok,[{atom,A5,foo}],_} = erl_scan:string("foo", {1,3}, ['end']),
    ...
    ?line {'end',{1,6}} = erl_scan:attributes_info(A5, 'end'),
...
unicode() ->
    ...
    Tags = [category, column, length, line, symbol, text, 'end'],
    ...
    ?line {ok,[Q2],{1,9}} = erl_scan:string("$\\x{aaa}", {1,1}, [text, 'end']),
    ?line [{category,integer},{column,1},{length,8},
           {line,1},{symbol,16#aaa},{text,Qs},{'end',{1,9}}] =
        erl_scan:token_info(Q2),

    U1 = "\"\\x{aaa}\"",
    ?line {ok,[T1,T2,T3],{1,10}} = erl_scan:string(U1, {1,1}, [text, 'end']),
    ?line [{category,'['},{column,1},{length,1},{line,1},
           {symbol,'['},{text,"\""},{'end',{1,2}}] =
        erl_scan:token_info(T1, Tags),
    ?line [{category,integer},{column,2},{length,7},
           {line,1},{symbol,16#aaa},{text,"\\x{aaa}"},{'end',{1,9}}] =
        erl_scan:token_info(T2, Tags),
    ?line [{category,']'},{column,9},{length,1},{line,1},
           {symbol,']'},{text,"\""},{'end',{1,10}}] =
        erl_scan:token_info(T3, Tags),
...
test_string(String, ExpectedWithEnd) ->
    {ok, ExpectedWithEnd, _EndWithEnd} =
        erl_scan:string(String, {1, 1}, ['end']),
